...
\begin{figure}[h]
    ...
    \subfloat[]{\resizebox{0.35\textwidth}{!}{%
    \begin{tabular}{|l|c|r|r|}
    \hline
    \multicolumn{2}{|l|}{\multirow{2}{*}{Reference times {[}s{]}}} & \multicolumn{2}{l|}{Follower} \\ \cline{3-4} 
    \multicolumn{2}{|l|}{} & \multicolumn{1}{c|}{H} & \multicolumn{1}{c|}{M} \\ \hline
    \multirow{2}{*}{Leader} & H & 98s & 123s \\ \cline{2-4} 
     & M & 74s & 74s \\ \hline
...
\multicolumn{2}{|c|}{\multirow{-2}{*}{RECAT-EU scheme}} & CAT-A & CAT-B & CAT-C & CAT-D & CAT-E & CAT-F \\ \hline
 ...
 & CAT-C &  & \cellcolor[HTML]{9AFF99}-25s (-25\%) & \cellcolor[HTML]{9AFF99}-41s (-38\%) & \cellcolor[HTML]{9AFF99}-49s (-40\%) & \cellcolor[HTML]{fd6864}+12s (+18\%) & \cellcolor[HTML]{fd6864}+64s (+93\%) \\ \cline{2-8} 
 & CAT-D &  &  & \cellcolor[HTML]{9AFF99}-49s (-40\%) & \cellcolor[HTML]{9AFF99}-49s (-40\%) &  & \cellcolor[HTML]{fd6864}+49s (+67\%) \\ \cline{2-8} 
 & CAT-E &  &  &  &  &  &  \\ \cline{2-8} 
...
In view of the aircraft pairs that experience change in separation under RECAT-EU, the time savings can potentially result in 35~seconds lower landing time interval (LTI) on average or decrease by 27,9\%. Those pair categories are indicated by a coloured background in Table~\ref{tab:time_saving}.
