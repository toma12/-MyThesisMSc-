...
\multicolumn{1}{|c|}{C-C} & \cellcolor[HTML]{FFEDCC}56 & \cellcolor[HTML]{FFEDCC}\textbf{110} & {\color[HTML]{9A0000} \textbf{74}} & \cellcolor[HTML]{CCE5E5}\textbf{108} & \cellcolor[HTML]{CCE5E5}223 & \cellcolor[HTML]{FFFFFF}\textbf{+2} & \cellcolor[HTML]{FFFFFF}{\color[HTML]{013300} \textbf{-34}} \\ \hline
\multicolumn{1}{|c|}{C-D} & \cellcolor[HTML]{FFEDCC}56 & \cellcolor[HTML]{FFEDCC}\textbf{110} & {\color[HTML]{9A0000} \textbf{74}} & \cellcolor[HTML]{CCE5E5}\textbf{96} & \cellcolor[HTML]{CCE5E5}217 & \cellcolor[HTML]{FFFFFF}\textbf{+14} & \cellcolor[HTML]{FFFFFF}{\color[HTML]{013300} \textbf{-22}} \\ \hline
\multicolumn{1}{|c|}{C-E} & \cellcolor[HTML]{FFEDCC}56 & \cellcolor[HTML]{FFEDCC}\textbf{110} & {\color[HTML]{9A0000} \textbf{98}} & \cellcolor[HTML]{CCE5E5}\textbf{107} & \cellcolor[HTML]{CCE5E5}227 & \cellcolor[HTML]{FFFFFF}\textbf{+3} & \cellcolor[HTML]{FFFFFF}{\color[HTML]{013300} \textbf{-8}} \\ \hline
...
\multicolumn{1}{|c|}{D-D} & \cellcolor[HTML]{FFEDCC}54 & \cellcolor[HTML]{FFEDCC}\textbf{110} & {\color[HTML]{9A0000} \textbf{74}} & \cellcolor[HTML]{CCE5E5}\textbf{108} & \cellcolor[HTML]{CCE5E5}230 & \cellcolor[HTML]{FFFFFF}\textbf{+2} & \cellcolor[HTML]{FFFFFF}{\color[HTML]{013300} \textbf{-34}} \\ \hline
\multicolumn{1}{|c|}{E-C} & \cellcolor[HTML]{FFEDCC}51 & \cellcolor[HTML]{FFEDCC}\textbf{134} & {\color[HTML]{9A0000} \textbf{74}} & \cellcolor[HTML]{CCE5E5}\textbf{100} & \cellcolor[HTML]{CCE5E5}224 & \cellcolor[HTML]{FFFFFF}\textbf{+34} & \cellcolor[HTML]{FFFFFF}{\color[HTML]{013300} \textbf{-26}} \\ \hline
\end{tabular}%
}
\caption{My caption}
\label{my-label}
