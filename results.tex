...
The shift from distance separation to time separation (between aircraft on approach for landing) is necessary in order to correlate the landing time interval (LTI) with the arrival runway occupancy time (AROT), both having the same dimension expressed in units of seconds. The assumption made here is, that the 5--95 percentile range of the AROT and LTI distributions describes normal operation of airfield at Keflavík without incursions and within safety limits. Therefore the relationship between the two metrics is accepted as the standard when evaluating the frequency distributions within the RECAT-EU scheme.  The acceptable overlap interval value of the percentile ranges is defined as 10 seconds. The position of the reference time line within the 5--95 percentile range of AROT is an indication that presently, under the ICAO scheme, the arrival runway occupancy time is the limiting factor for the airfield capacity.  
...
\begin{figure}[h]
    \centering
    \subfloat[]{\includegraphics[width=1\textwidth]{graphics/fig_CC_from_HH_pairs_time_sep.png}\label{fig:CC_from_HH_pairs_time_sep}}
    ...
    \multicolumn{1}{l|}{} & \multicolumn{2}{c|}{\begin{tabular}[c]{@{}c@{}}AROT of leader\\ percentile range {[}s{]}\end{tabular}} &  & \multicolumn{2}{c|}{\begin{tabular}[c]{@{}c@{}}LTI\\ percentile range {[}s{]}\end{tabular}} &  \\ \cline{2-3} \cline{5-6}
     & 5\% & 95\% & \multirow{-2}{*}{\begin{tabular}[c]{@{}c@{}}Reference\\ time {[}s{]}\end{tabular}} & 5\% & 95\% & \multirow{-2}{*}{\begin{tabular}[c]{@{}c@{}}Potential\\ time savings {[}s{]}\end{tabular}} \\ \hline
    \multicolumn{1}{|c|}{C-C} & \cellcolor[HTML]{ffedcc}53 & \cellcolor[HTML]{ffedcc}\textbf{110} & {\color[HTML]{9A0000} \textbf{74}} & \cellcolor[HTML]{cce5e5}\textbf{120} & \cellcolor[HTML]{cce5e5}220 & \textbf{-20} \\ \hline
    \end{tabular}%
    }}
...
\begin{figure}[h]
    ...
    \multicolumn{1}{l|}{} & \multicolumn{2}{c|}{\begin{tabular}[c]{@{}c@{}}AROT of leader \\ percentile range {[}s{]}\end{tabular}} &  & \multicolumn{2}{c|}{\begin{tabular}[c]{@{}c@{}}LTI\\ percentile range {[}s{]}\end{tabular}} &  \\ \cline{2-3} \cline{5-6}
     & 5\% & 95\% & \multirow{-2}{*}{\begin{tabular}[c]{@{}c@{}}Reference\\ time {[}s{]}\end{tabular}} & 5\% & 95\% & \multirow{-2}{*}{\begin{tabular}[c]{@{}c@{}}Potential\\ time savings {[}s{]}\end{tabular}} \\ \hline
    \multicolumn{1}{|c|}{C-C} & \cellcolor[HTML]{ffedcc}53 & \cellcolor[HTML]{ffedcc}\textbf{110} & {\color[HTML]{9a0000} \textbf{74}} & \cellcolor[HTML]{cce5e5}\textbf{118} & \cellcolor[HTML]{cce5e5}226 & \textbf{-18} \\ \hline
    \multicolumn{1}{|c|}{C-D} & \cellcolor[HTML]{ffedcc}52 & \cellcolor[HTML]{ffedcc}\textbf{111} & {\color[HTML]{9a0000} \textbf{74}} & \cellcolor[HTML]{cce5e5}\textbf{120} & \cellcolor[HTML]{cce5e5}221 &  \textbf{-19} \\ \hline
    \end{tabular}%
    }}
    
    \caption[AROT and LTI of C-C and C-D pairs originating from ICAO H-M pairs]{AROT and landing time intervals of \protect\subref{fig:CC_from_HM_pairs_time_sep} C-C and \protect\subref{fig:CD_from_HM_pairs_time_sep} C-D pairs originating from ICAO H-M pairs. The dashed red line indicates the RECAT-EU reference time separation for the C-D pairs.}
\end{figure}
