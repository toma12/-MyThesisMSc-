...
\begin{figure}[h]
    \centering
    \subfloat[]{\includegraphics[width=1\textwidth]{graphics/fig_best_CC_from_HM_pairs_time_sep.png}\label{fig:best_CC_from_HM_pairs_time_sep}}
